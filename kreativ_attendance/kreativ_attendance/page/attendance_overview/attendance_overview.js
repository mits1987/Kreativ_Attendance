// Attendance Overview — the month-end control panel.
...
frappe.pages['attendance-overview'].on_page_load = function(wrapper) {
	var page = frappe.ui.make_app_page({
		parent: wrapper,
		title: __('Attendance Overview'),
		single_column: true,
	});
